...
/**
 * Register a callback to be invoked after grant request is parsed.
 *
 * @param {Function} cb
...
/**
 * Register a callback to be invoked when grant response calls `next()`.
 *
 * @param {Function} cb
 * @return {Test} for chaining
 * @api public
...
/**
 * Register a callback to be invoked when grant response `end()`s response.
 *
 * @param {Function} cb
 * @return {Test} for chaining
 * @api public
...
/**
 * Register a callback to be invoked when OAuth 2.0 transaction response is
 * prepared.
 *
 * @param {Function} cb
 * @return {Test} for chaining
